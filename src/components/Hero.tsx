          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={index} className="flex items-start sm:items-center gap-3 text-left">
            ...
            {/* Trust indicators */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 pt-4 justify-center lg:justify-start">
